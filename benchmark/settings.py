...
MIDDLEWARE = [
    ...
    'benchmark.middleware.LoginRequiredMiddleware',
    'benchmark.middleware.AdminAccessMiddleware',
]
...
CRONJOBS = [
    ('*/30 * * * *', 'apps.vacancies.views.handle', '>> ' + os.path.join(BASE_DIR,'log/debug.log' + ' 2>&1 '))
]
