"""
Django settings for CandBechmark project.
...
SECRET_KEY = 'django-insecure-o-+l@0$xtwef1s)sa_dao9s0$qj#2_(y^!2n6s5-wn2jsy_z=e'
...
#GEMINI_API_URL = f'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key={GOOGLE_API_KEY}'  # замените на корректный URL!
