...
from apps.vacancies.models import GeminiPrompt, Vacancy, UserProfile
from apps.vacancies.utils import unify_currency, unify_grade  # <-- Функции «причесывания», см. Шаг 0
